...
contract MarketSentiment {
    ...
    function addTicker(string memory _ticker) public {
        ...
        tickersArray.push(_ticker); //sets it on the contract
    }

    function vote(string memory _ticker, bool _vote) public {
        require(Tickers[_ticker].exists, 'Cannot vote on this coin');
        require(!Tickers[_ticker].Voters[msg.sender], 'You have already voted for this coin'); //this has to be true for the contract to continue
